...
CREATE USER 'proviso_userx`'@'localhost' IDENTIFIED WITH mysql_native_password BY 'provisopass';
...
INSERT INTO customer(cust_id, email, last_name, first_name, password, loyalty)
